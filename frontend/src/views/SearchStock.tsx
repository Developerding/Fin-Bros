...
import { Paper, Avatar, Grid, Stack, TextField, Popper, MenuList, MenuItem, Typography } from "@mui/material";
    ...
    return (
        ...
        <Paper >
            ...
            <Grid>
                ...
                <Avatar src={`/assets/stocks/${stock?.name}.png`} sx={{ width: 100, height: 100}} />
                <h1>{stock?.name }</h1>
                </Stack>
            </Grid>
